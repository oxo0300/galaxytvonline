...
$_lang['setting_modmobile.use_if'] = 'Use [[If]]';
$_lang['setting_modmobile.use_if_desc'] = 'If set to Yes, this will assign the URL Get Variable as an option/property to be used via an [[If]] in a template/chunk/snippet and will not switch templates.';