...
$resources = $modx->getCollection('modResource',array('published'=>1, 'show_in_tree'=>1, 'type' => 'document', 'contentType' => 'text/html', 'deleted' => '0'));
$output = '<p style="padding:10px;"><b style="text-decoration:underline">The following settings are required for '.$packagename.' to function correctly:</b></p>
...
<i>The App ID assigned to your app in the Facebook Developer app.</i><br/>
...
<i>The App Secret assigned to your app in the Facebook Developer app.</i><br/>
...
<i>A comma delimited list of usergroups you want to assign new Facebook users to on registration.</i><br/>
...
<i>A comma delimited list of permissions your app needs to request from the Facebook user.</i><br/>
...
<i>Choose the alias of your dedicated login resource.</i><br/>';
...
<i>Choose the alias of the resource returning Facebook users should be directed to after login.</i><br/>
...
<i>Choose the alias of the resource new Facebook users should be directed to after their first login - for instance you may want them to complete their profile.</i><br/>';
...
<i>Choose the alias of the resource Facebook users should be directed to when they cancel a Facebook action - usually the same as your login resource ID</i><br/>';
